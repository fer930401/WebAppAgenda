<%@ Page Title="Reporte Confirmadas - Skytex Mexico" Language="C#" MasterPageFile="~/Agenda.Master" AutoEventWireup="true" CodeBehind="reporteEntregadas.aspx.cs" Inherits="Prueba.Presentacion.reporteEntregadas" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3" >
                <h3><p class="text-justify"><img src="Media/Imagenes/skytex.png" width="190" height="90" />Ordenes Confirmadas</p></h3>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-4">
                <ul class="list-inline">
                  <li><img class="" src="Media/Imagenes/excel.png" width="40" height="40"/></li>
                  <asp:Button OnClick="exportarExcel_Click" CssClass="btn btn-success" Text="Exportar Excel" runat="server"/>
                </ul>
            </div>
            <div class="col-xs-6 col-sm-4">
                <ul class="list-inline">
                  <li><img class="" src="Media/Imagenes/word.png" width="40" height="40"/></li>
